...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    private ImageView mGps, mInfo, mPlacePicker,uploca;
...
//        uploca = findViewById(R.id.uploca);
...
//        uploca.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                if (mMarker.isVisible()) {
////                    Intent intent = new Intent(MapActivity.this,UploadFragment.class);
////                    intent.putExtra("la",mMarker.getPosition().latitude);
////                    intent.putExtra("long",mMarker.getPosition().longitude);
//                    Bundle bundle = new Bundle();
//                    bundle.putInt("la", (int) mMarker.getPosition().latitude);
//                    bundle.putInt("long", (int) mMarker.getPosition().longitude);
...
//                Log.d(TAG, "onResult: attributions: " + place.getAttributions());
    ...
    public void onMapLongClick(LatLng latLng) {
     mMap.addMarker(new MarkerOptions().position(latLng).title("your choosen place"));
    }
}
